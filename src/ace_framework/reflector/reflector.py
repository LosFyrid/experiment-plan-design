...
Implements ACE paper §3 Reflector role with:
...
class PlanReflector:
    ...
    Implements the Reflector role from ACE paper §3 with iterative
    ...
    def reflect(
        ...
        Implements ACE Reflector with iterative refinement (§3, Figure 4).
    ...
    def _perform_iterative_refinement(
        ...
        Implements ACE paper §3, Figure 4.

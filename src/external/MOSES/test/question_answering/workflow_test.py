...
# Add MOSES root to sys.path to enable absolute imports
MOSES_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
if MOSES_ROOT not in sys.path:
    sys.path.insert(0, MOSES_ROOT)
...
for run_num in range(1, args.runs + 1):
    ...
    total_qas = [
        {
        "question": "You are an expert in the field of Duplex Stainless Steel. You are tasked with extracting all experimental details from academic research articles in the DSS field. Please first draft a hierarchy of all the information that you would extract.",
        }
    ]
